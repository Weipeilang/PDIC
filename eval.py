...
# Input paths
#########################################################
parser.add_argument('--model', type=str, default='save/nsc-sat-2-from-nsc-seqkd/model-best.pth',
...
parser.add_argument('--infos_path', type=str,
    default='save/nsc-sat-2-from-nsc-seqkd/infos_nsc-sat-2-from-nsc-seqkd-best.pkl',
...
parser.add_argument('--input_label_h5', type=str, default='',
                help='path to the h5file containing the preprocessed dataset')
parser.add_argument('--input_json', type=str, default='../satic-main/data/cocotalk.json',
...
# misc
#######################################################
parser.add_argument('--id', type=str, default='nsc-sat-2-from-nsc-seqkd',
