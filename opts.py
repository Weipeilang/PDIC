...
def parse_opt():
    ...
    ###################################################################################
    parser.add_argument('--input_label_h5', type=str, default='../satic-main/data/cocotalk_seq-kd-from-nsc-transformer-baseline-b5_label.h5', help='path to the h5file containing the preprocessed dataset')
    ###################################################################################
    parser.add_argument('--start_from', type=str, default=None, # 'save/sat-3-from-nsc-seqkd' ,
    ...
    parser.add_argument('--max_epochs', type=int, default=15, help='number of epochs')
    ...
    parser.add_argument('--save_checkpoint_every', type=int, default=3000, help='how often to save a model checkpoint (in iterations)?')
    parser.add_argument('--save_history_ckpt', type=int, default=0,help='If save checkpoints at every save point')
    #######################################################################################
    parser.add_argument('--checkpoint_path', type=str, default='save/sat-4-from-nsc-seqkd', help='directory to store checkpointed models')
    #######################################################################################
